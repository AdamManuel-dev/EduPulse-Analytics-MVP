...
class TestPredictionService:
    ...
    def test_initialization_with_model(self):
        ...
        with patch("src.services.prediction_service.GRUAttentionModel") as _mock_model_class, patch(
            "src.services.prediction_service.FeaturePipeline"
        ) as mock_pipeline_class, patch("src.services.prediction_service.get_db") as mock_db, patch(
            ...
            _mock_model_class.assert_called_once()
    ...
    def test_load_model_success(self, prediction_service):
        ...
        with patch("torch.load") as mock_torch_load:
            ...
            mock_torch_load.assert_called_once_with(
                model_path, map_location=prediction_service.device
            )
    ...
    def test_predict_risk_fallback(self, prediction_service):
        ...
        with patch.object(
            prediction_service, "prepare_sequence", side_effect=Exception("Prep failed")
        ):
            result = prediction_service.predict_risk(student_id)
    ...
    def test_predict_batch_partial_failure(self, prediction_service):
        ...
        with patch.object(
            prediction_service, "prepare_sequence", side_effect=mock_prep_side_effect
        ):
            results = prediction_service.predict_batch(student_ids)
...
class TestPredictionServiceIntegration:
    ...
    def test_end_to_end_prediction_flow(self):
        ...
        with patch("src.services.prediction_service.GRUAttentionModel") as _mock_model_class, patch(
            "src.services.prediction_service.FeaturePipeline"
        ) as mock_pipeline_class, patch("src.services.prediction_service.get_db"):
            # Setup mocks
            mock_model = Mock()
