...
class GradeFeatureExtractor(BaseFeatureExtractor):
    ...
    def _analyze_by_assignment_type(self, grades: List[models.Grade]) -> Dict[str, float]:
        ...
        for grade in grades:
            ...
            if 'test' in assignment_lower or 'exam' in assignment_lower or 'quiz' in assignment_lower:
                test_grades.append(grade.grade_value)
            elif 'homework' in assignment_lower or 'hw' in assignment_lower or 'assignment' in assignment_lower:
